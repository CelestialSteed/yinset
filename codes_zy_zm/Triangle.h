...
public:
    ...
    std::vector<Integer> findall(const Edge &e) const;
...
std::vector<Integer> TriangleList::findall(const Edge &e) const
{
    std::vector<Integer> res;
    for (Integer i = 0; i < (Integer)triangle.size(); i++)
    {
        ...
        else if (triangle[i](0) == e(1) && triangle[i](2) == e(0))
        {
            res.push_back(i);
        }
        else if (triangle[i](0) == e(1) && triangle[i](1) == e(0))
        {
            res.push_back(i);
        }
        else if (triangle[i](1) == e(1) && triangle[i](2) == e(0))
        {
            res.push_back(i);
        }
        else if (triangle[i](1) == e(0) && triangle[i](2) == e(1))
